...
urlpatterns = [
    ...
    path('student/addgroup/', group_admin_add_view, name='admin_add_group'),
    path('student/add_s/', student_admin_add_view, name='admin_add_student'),
    path('student/add/', student_add_view, name='add_student'),
    path('student/<int:pk>/edit/', edit_student, name='student_edit'),
    path('children/<int:pk>/edit/', edit_children, name='children_edit'),
    ...
    path('parent_delete/<int:pk>', parent_delete, name='parent_delete'),

    path('parents_list/', parent_lsit, name='parents_list'),
