...
urlpatterns = [
    ...
    path('course/assign/', CourseAllocationFormView, name='course_allocation'),
    ...
    # course session
    path('course/allocated_session/', course_session, name="course_session"),
    path('course/allocated_session/<int:pk>', course_session_parent, name="course_session_student"),
    path('course/allocated_session/Add/', course_session_form, name="course_session_add"),
    path('course/allocated_session/<int:pk>/edit/', course_session_edit, name="course_session_edit"),
    path('course/allocated_session/<int:pk>/delete/', del_course_session, name="course_session_delete"),
]
